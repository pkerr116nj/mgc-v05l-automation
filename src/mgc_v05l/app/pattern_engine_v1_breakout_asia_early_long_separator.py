"""Separator analysis for the ASIA_EARLY LONG breakout_retest_hold lane."""
...
def build_and_write_breakout_asia_early_long_separator(*, detail_csv_path: Path) -> dict[str, str]:
    ...
    lane_summary_path = prefix.with_suffix(".pattern_engine_v1_breakout_asia_early_long_lane_summary.json")
    candidate_csv_path = prefix.with_suffix(".pattern_engine_v1_breakout_asia_early_long_separator_candidates.csv")
    summary_json_path = prefix.with_suffix(".pattern_engine_v1_breakout_asia_early_long_separator_summary.json")
...
def _build_summary_payload(*, lane_summary: dict[str, Any], candidate_rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "best_candidate_separator": best_promotable,
        "useful_secondary_separators": useful_secondaries,
        "broad_or_noisy_separators": broad_noise,
        "highest_lift_thin_separator": highest_lift_thin,
    }
...
def main() -> None:
    ...
    outputs = build_and_write_breakout_asia_early_long_separator(detail_csv_path=args.detail_csv_path)
