"""Separator analysis for the US_MIDDAY pause_rebound_resume_short lane."""
...
def build_and_write_us_midday_pause_short_separator(*, detail_csv_path: Path) -> dict[str, str]:
    ...
    lane_summary_path = prefix.with_suffix(".pattern_engine_v1_us_midday_pause_short_lane_summary.json")
    candidate_csv_path = prefix.with_suffix(".pattern_engine_v1_us_midday_pause_short_separator_candidates.csv")
    summary_json_path = prefix.with_suffix(".pattern_engine_v1_us_midday_pause_short_separator_summary.json")
...
def main() -> None:
    ...
    outputs = build_and_write_us_midday_pause_short_separator(detail_csv_path=args.detail_csv_path)
