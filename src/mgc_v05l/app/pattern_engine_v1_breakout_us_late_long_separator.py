"""Separator analysis for the US_LATE LONG breakout_retest_hold lane."""
...
def build_and_write_breakout_us_late_long_separator(*, detail_csv_path: Path) -> dict[str, str]:
    ...
    lane_summary_path = prefix.with_suffix(".pattern_engine_v1_breakout_us_late_long_lane_summary.json")
    candidate_csv_path = prefix.with_suffix(".pattern_engine_v1_breakout_us_late_long_separator_candidates.csv")
    summary_json_path = prefix.with_suffix(".pattern_engine_v1_breakout_us_late_long_separator_summary.json")
...
def _build_summary_payload(*, lane_summary: dict[str, Any], candidate_rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "broad_or_noisy_examples": broad_noise,
        "highest_lift_thin_example": highest_lift_thin,
...
def main() -> None:
    ...
    result = build_and_write_breakout_us_late_long_separator(detail_csv_path=args.detail_csv)
