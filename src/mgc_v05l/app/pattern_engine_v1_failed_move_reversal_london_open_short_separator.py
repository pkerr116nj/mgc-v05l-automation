"""Separator analysis for the LONDON_OPEN SHORT failed_move_reversal lane."""
...
def build_and_write_failed_move_reversal_london_open_short_separator(*, detail_csv_path: Path) -> dict[str, str]:
    ...
    lane_summary_path = prefix.with_suffix(".pattern_engine_v1_failed_move_reversal_london_open_short_lane_summary.json")
    candidate_csv_path = prefix.with_suffix(
        ".pattern_engine_v1_failed_move_reversal_london_open_short_separator_candidates.csv"
    )
    summary_json_path = prefix.with_suffix(
        ".pattern_engine_v1_failed_move_reversal_london_open_short_separator_summary.json"
    )
...
def main() -> None:
    ...
    result = build_and_write_failed_move_reversal_london_open_short_separator(detail_csv_path=args.detail_csv)
