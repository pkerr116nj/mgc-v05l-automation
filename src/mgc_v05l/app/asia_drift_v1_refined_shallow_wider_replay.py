"""Runner for wider-date replay research on Asia Drift refined shallow participation."""
...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "reports" / "asia_drift_v1_refined_shallow_wider_replay"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="asia-drift-v1-refined-shallow-wider-replay")
...
def run_asia_drift_v1_refined_shallow_wider_replay(
    *,
    source_db: Path,
    instrument: str = "MGC",
    ...
    result = run_refined_shallow_wider_research(
    ...
    return {
        ...
        "aggregate_json_path": artifacts["aggregate_json_path"],
        "aggregate_markdown_path": artifacts["aggregate_markdown_path"],
        "window_rows_path": artifacts["window_rows_path"],
        "candidate_trade_manifest_path": artifacts["candidate_trade_manifest_path"],
        "opportunity_manifest_path": artifacts["opportunity_manifest_path"],
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = run_asia_drift_v1_refined_shallow_wider_replay(
