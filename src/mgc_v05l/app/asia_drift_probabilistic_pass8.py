"""Runner for the eighth controlled Asia Drift probabilistic pass."""
...
from ..research.asia_drift.probabilistic_pass8 import run_probabilistic_pass8
...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "reports" / "asia_drift_probabilistic_pass8" / "index_stack_20200101_20260421"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="asia-drift-probabilistic-pass8")
    ...
    parser.add_argument("--output-dir", default=str(DEFAULT_OUTPUT_ROOT), help="Output directory for pass8 artifacts.")
    return parser


def run_asia_drift_probabilistic_pass8(
    *,
    pass1_root: Path,
    warehouse_root: Path,
    ...
    result = run_probabilistic_pass8(
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = run_asia_drift_probabilistic_pass8(
