"""Runner for broader replay research on Asia Drift refined shallow participation."""
...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "reports" / "asia_drift_v1_refined_shallow_replay"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="asia-drift-v1-refined-shallow-replay")
...
def run_asia_drift_v1_refined_shallow_replay(
    *,
    source_db: Path,
    instrument: str = "MGC",
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = run_asia_drift_v1_refined_shallow_replay(
