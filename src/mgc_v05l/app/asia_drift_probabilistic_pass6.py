"""Runner for the sixth controlled Asia Drift probabilistic pass."""
...
from ..research.asia_drift.probabilistic_pass6 import run_probabilistic_pass6
...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "outputs" / "reports" / "asia_drift_probabilistic_pass6" / "index_stack_20200101_20260421"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="asia-drift-probabilistic-pass6")
    ...
    parser.add_argument("--output-dir", default=str(DEFAULT_OUTPUT_ROOT), help="Output directory for pass6 artifacts.")
    return parser


def run_asia_drift_probabilistic_pass6(*, pass1_root: Path, warehouse_root: Path, output_dir: Path) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = run_asia_drift_probabilistic_pass6(
