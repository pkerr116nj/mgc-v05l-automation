...
MNQ_US_MIDDAY_PAUSE_RESUME_SHORT_TURN_V1 = TrackBStrategyRegistryEntry(
    ...
    timeframe="5m",
    required_feature_schema=(
        "metadata.mnq_us_midday_pause_resume_short_turn_features.normalized_slope",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.normalized_curvature",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.signal_range_expansion_ratio",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.close_below_open",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.close_below_previous_close",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.derivative_bear_close_weak",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.derivative_bear_range_ok",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.derivative_bear_body_ok",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.derivative_bear_stretch_ok",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.one_bar_rebound_before_signal",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.prior_3_any_positive_curvature",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.signal_breaks_prior_1_low",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.derivative_bear_cooldown_ok",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.no_competing_bear_short_candidate",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.feature_version",
        "metadata.mnq_us_midday_pause_resume_short_turn_features.calibration_profile",
    ),
    required_state_schema=(
        "metadata.mnq_us_midday_pause_resume_short_turn_state.derivative_phase",
        "metadata.mnq_us_midday_pause_resume_short_turn_state.session_us",
        "metadata.mnq_us_midday_pause_resume_short_turn_state.allow_us",
        "metadata.mnq_us_midday_pause_resume_short_turn_state.midday_pause_resume_window_ok",
    ),
    feature_version="mnq_us_midday_pause_resume_short_turn_v1_phase1",
    calibration_profile="probationary_baseline_v1",
    paper_eligible=True,
    live_money_eligible=False,
    evaluation_mode="COMPLETED_BAR_ONLY",
    managed_exit_policy_id=PAPER_DIAGNOSTIC_TIME_BOXED_3X5M_EXIT_V1,
    exit_not_available=False,
    accepted_strategy_ids=("MNQ_US_MIDDAY_PAUSE_RESUME_SHORT_TURN_V1",),
    accepted_rule_ids=("MNQ_US_MIDDAY_PAUSE_RESUME_SHORT_TURN_V1",),
)
...
_BATCH1_ACTIVE_EVIDENCE_SYMBOLS = ("MGC", "GC", "NQ", "ES", "ZT", "ZF", "ZN", "ZB", "BTC", "MBT", "ETH", "MET")
...
TRACK_B_STRATEGY_REGISTRY: tuple[TrackBStrategyRegistryEntry, ...] = (
    ...
    MNQ_US_MIDDAY_PAUSE_RESUME_SHORT_TURN_V1,
