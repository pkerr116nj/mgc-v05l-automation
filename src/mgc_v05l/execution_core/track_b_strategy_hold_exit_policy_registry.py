...
APPROVED_TRACK_B_STRATEGY_HOLD_EXIT_POLICIES: Mapping[str, StrategyHoldExitPolicy] = {
    ...
    "MNQ_US_MIDDAY_PAUSE_RESUME_SHORT_TURN_V1": _policy(
        ...
        hold_policy_id="PAUSE_RESUME_CONTINUATION_HOLD_SHADOW_V1",
        exit_policy_family="CONTINUATION_DECAY_OR_TIMEBOX_SHADOW",
        profit_harvest_policy="MNQ_CONTINUATION_PROFIT_HARVEST_SHADOW_V1",
        thesis_failure_conditions=("pause_resume_context_fails", "opposite_signal_confirms"),
        participation_decay_inputs=("phase1_5m_closes", "participation_decay", "microtrend_shadow"),
        conflict_group="equity_index_nasdaq_mnq_nq",
    ),
    ...
    "PAPER_ACTIVE_EVIDENCE_MNQ_LONDON_OPEN_PARTICIPATION_LONG_V1": _policy(
        ...
        hold_policy_id="LONDON_OPEN_ACTIVE_EVIDENCE_15M_TIMEBOX_HOLD_V1",
    ...
    "PAPER_ACTIVE_EVIDENCE_MNQ_LONDON_LATE_PARTICIPATION_SHORT_V1": _policy(
        ...
        thesis_type="TREND_PARTICIPATION",
        expected_hold_type="TIMEBOXED",
        hold_policy_id="LONDON_LATE_ACTIVE_EVIDENCE_15M_TIMEBOX_HOLD_V1",
        exit_policy_family="LONDON_LATE_ACTIVE_EVIDENCE_TIMEBOX_ONLY",
        profit_harvest_policy=None,
        thesis_failure_conditions=("price_recovers_london_late_reference", "opposite_recent_close_confirms"),
        participation_decay_inputs=("phase1_1m_closes", "london_late_0530_reference", "vwap_if_available"),
        conflict_group="equity_index_mnq_mes_london_late_active_evidence",
        max_hold_policy="3_COMPLETED_5M_BARS",
    ),
    "PAPER_ACTIVE_EVIDENCE_MES_LONDON_LATE_PARTICIPATION_SHORT_V1": _policy(
