...
def main(
    ...
    *,
    ...
    try:
        ...
        provider_available_end_text = (
            provider_available_end.isoformat() if provider_available_end is not None else parser_diagnostics.get("provider_available_end")
        )
        corrective_message = (
        ...
        report = {
            ...
            "provider_available_end": provider_available_end_text,
            "provider_available_end_initial": parser_diagnostics.get("provider_available_end_initial"),
            "provider_available_end_final": parser_diagnostics.get("provider_available_end_final"),
            ...
            "requested_quote_start": parser_diagnostics.get("requested_quote_start"),
            "requested_quote_end": parser_diagnostics.get("requested_quote_end"),
            "actual_quote_start": parser_diagnostics.get("actual_quote_start"),
            "actual_quote_end": parser_diagnostics.get("actual_quote_end"),
            "available_end_fallback_used": parser_diagnostics.get("available_end_fallback_used"),
            "available_end_buffer_seconds": parser_diagnostics.get("available_end_buffer_seconds"),
            "allow_available_end_fallback_requested": parser_diagnostics.get("allow_available_end_fallback_requested"),
            "allow_available_end_fallback_effective": parser_diagnostics.get("allow_available_end_fallback_effective"),
            "native_databento_path_used": parser_diagnostics.get("native_databento_path_used"),
            "schemas_attempted": parser_diagnostics.get("schemas_attempted"),
            "available_end_retry_attempted": parser_diagnostics.get("available_end_retry_attempted"),
            "available_end_retry_count": parser_diagnostics.get("available_end_retry_count"),
            "available_end_retry_reason": parser_diagnostics.get("available_end_retry_reason"),
            ...
            "native_databento_error_code": parser_diagnostics.get("native_databento_error_code"),
            "native_databento_error_message": parser_diagnostics.get("native_databento_error_message"),
            "native_exception_class": parser_diagnostics.get("native_exception_class"),
            "native_exception_message_sanitized": parser_diagnostics.get("native_exception_message_sanitized"),
            ...
            json.dumps(
                {
                    ...
                    "provider_available_end_initial": report["provider_available_end_initial"],
                    "provider_available_end_final": report["provider_available_end_final"],
                    "corrective_message": corrective_message,
                    ...
                    "start": report["start"],
                    "end": report["end"],
                    "requested_quote_start": report["requested_quote_start"],
                    "requested_quote_end": report["requested_quote_end"],
                    "actual_quote_start": report["actual_quote_start"],
                    "actual_quote_end": report["actual_quote_end"],
                    "available_end_fallback_used": report["available_end_fallback_used"],
                    "available_end_buffer_seconds": report["available_end_buffer_seconds"],
                    "allow_available_end_fallback_requested": report["allow_available_end_fallback_requested"],
                    "allow_available_end_fallback_effective": report["allow_available_end_fallback_effective"],
                    "native_databento_path_used": report["native_databento_path_used"],
                    "schemas_attempted": report["schemas_attempted"],
                    "available_end_retry_attempted": report["available_end_retry_attempted"],
                    "available_end_retry_count": report["available_end_retry_count"],
                    "available_end_retry_reason": report["available_end_retry_reason"],
                    "encoding": report["encoding"],
                    "request_details": report["request_details"],
                    "raw_provider_error": report["raw_provider_error"],
                    "native_databento_error_code": report["native_databento_error_code"],
                    "native_databento_error_message": report["native_databento_error_message"],
                    "native_exception_class": report["native_exception_class"],
                    "native_exception_message_sanitized": report["native_exception_message_sanitized"],
    ...
    report = {
        ...
        "quote_window": {
            ...
            "provider_available_end_initial": quote.raw.get("provider_available_end_initial"),
            "provider_available_end_final": quote.raw.get("provider_available_end_final"),
            "available_end_fallback_used": quote.raw.get("available_end_fallback_used"),
            "available_end_buffer_seconds": quote.raw.get("available_end_buffer_seconds"),
            "allow_available_end_fallback_requested": quote.raw.get("allow_available_end_fallback_requested"),
            "allow_available_end_fallback_effective": quote.raw.get("allow_available_end_fallback_effective"),
            "native_databento_path_used": quote.raw.get("native_databento_path_used"),
            "schemas_attempted": quote.raw.get("schemas_attempted"),
            "available_end_retry_attempted": quote.raw.get("available_end_retry_attempted"),
            "available_end_retry_count": quote.raw.get("available_end_retry_count"),
            "available_end_retry_reason": quote.raw.get("available_end_retry_reason"),
