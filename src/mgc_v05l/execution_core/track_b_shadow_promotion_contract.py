...
from mgc_v05l.execution_core.track_b_exit_strategy_roster import (
    ...
    ETH_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ETH_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ...
    MET_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    MET_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ...
    MSL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    MSL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    NQ_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    NQ_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    SOL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    SOL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
...
_BATCH1_ACTIVE_EVIDENCE_CONTRACTS = {
    ...
    "ZT": {
        ...
        "con_id": 842590391,
        "point_value": "2000",
        "conflict_group": "rates_treasury_active_evidence",
        "activation_batch": "PAPER_NOISEMAKER_CHAOS_BATCH_2",
    },
    "ZF": {
    ...
    "BTC": {
        ...
        "con_id": 772435574,
        "point_value": "5",
        "conflict_group": "crypto_bitcoin_active_evidence",
        "activation_batch": "PAPER_NOISEMAKER_CRYPTO_READINESS_ONLY",
    },
    "MBT": {
        ...
        "point_value": "0.1",
        "conflict_group": "crypto_bitcoin_active_evidence",
        "activation_batch": "PAPER_NOISEMAKER_CRYPTO_BATCH",
    },
    "ETH": {
        ...
        "con_id": 772435593,
        "point_value": "50",
        "conflict_group": "crypto_ether_active_evidence",
        "activation_batch": "PAPER_NOISEMAKER_CRYPTO_READINESS_ONLY",
    },
    "MET": {
    ...
    "SOL": {
        ...
        "con_id": 772435608,
        "point_value": "500",
        "conflict_group": "crypto_solana_active_evidence",
        "activation_batch": "PAPER_NOISEMAKER_CRYPTO_READINESS_ONLY",
    },
    "MSL": {
...
_BATCH1_ACTIVE_EVIDENCE_EXIT_PROFILES = {
    ...
    ("ZT", "US"): ZT_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("ZF", "US"): ZF_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("ZN", "US"): ZN_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("ZB", "US"): ZB_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("BTC", "US"): BTC_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("MBT", "US"): MBT_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("ETH", "US"): ETH_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("MET", "US"): MET_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("SOL", "US"): SOL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ("MSL", "US"): MSL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1,
    ...
    ("ZT", "GLOBEX"): ZT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZF", "GLOBEX"): ZF_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZN", "GLOBEX"): ZN_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZB", "GLOBEX"): ZB_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("BTC", "GLOBEX"): BTC_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MBT", "GLOBEX"): MBT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ETH", "GLOBEX"): ETH_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MET", "GLOBEX"): MET_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("SOL", "GLOBEX"): SOL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MSL", "GLOBEX"): MSL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ...
    ("ZT", "LONDON_OPEN"): ZT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZF", "LONDON_OPEN"): ZF_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZN", "LONDON_OPEN"): ZN_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZB", "LONDON_OPEN"): ZB_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("BTC", "LONDON_OPEN"): BTC_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MBT", "LONDON_OPEN"): MBT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ETH", "LONDON_OPEN"): ETH_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MET", "LONDON_OPEN"): MET_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("SOL", "LONDON_OPEN"): SOL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MSL", "LONDON_OPEN"): MSL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ...
    ("ZT", "LONDON_LATE"): ZT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZF", "LONDON_LATE"): ZF_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZN", "LONDON_LATE"): ZN_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ZB", "LONDON_LATE"): ZB_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("BTC", "LONDON_LATE"): BTC_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MBT", "LONDON_LATE"): MBT_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("ETH", "LONDON_LATE"): ETH_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MET", "LONDON_LATE"): MET_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("SOL", "LONDON_LATE"): SOL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
    ("MSL", "LONDON_LATE"): MSL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1,
}
    ...
    for symbol, contract in _BATCH1_ACTIVE_EVIDENCE_CONTRACTS.items():
        for session, direction, lane_suffix, lane_mode in _BATCH1_ACTIVE_EVIDENCE_SESSIONS:
            ...
            candidates[strategy_id] = ShadowPromotionCandidate(
                ...
                evidence_summary={
                    "activation_batch": str(contract.get("activation_batch") or "PAPER_NOISEMAKER_CHAOS_BATCH_1"),
                    "contract_identity_source": "noisemaker_contract_tick_readiness",
                    "max_position_quantity": 1,
                },
                experimental_reason=(
                    "paper_noisemaker_chaos_batch_2_active_evidence_expansion"
                    if contract.get("activation_batch") == "PAPER_NOISEMAKER_CHAOS_BATCH_2"
                    else "paper_noisemaker_chaos_batch_1_active_evidence_expansion"
                ),
...
PROMOTION_CANDIDATES: Mapping[str, ShadowPromotionCandidate] = {
    ...
    PAPER_ACTIVE_EVIDENCE_MNQ_LONDON_LATE_SHORT_PROMOTED_ID: ShadowPromotionCandidate(
        shadow_candidate_family="PAPER_ONLY_LONDON_LATE_ACTIVE_EVIDENCE_LANE",
        promoted_strategy_id=PAPER_ACTIVE_EVIDENCE_MNQ_LONDON_LATE_SHORT_PROMOTED_ID,
        ...
        evidence_summary={
            ...
            "purpose": "controlled_real_paper_lifecycle_evidence_generation_london_late_mnq_short",
        },
        experimental_reason="paper_only_london_late_active_evidence_generation_mnq_short",
        display_name="MNQ / London Late active participation short / PAPER evidence",
        identity_components=("paper", "mnq", "london_late", "active_participation_short"),
