...
def _build_report(
    *,
    ...
    return {
        ...
        "databento_dependency_status": _value(quote.payload if quote else {}, "databento_dependency_status"),
        "databento_live_api_available": _value(quote.payload if quote else {}, "databento_live_api_available"),
        "provider_error_category": _value(quote.payload if quote else {}, "provider_error_category"),
        "symbol_subscription_attempted": _value(quote.payload if quote else {}, "symbol_subscription_attempted"),
        "symbol_subscription_succeeded": _value(quote.payload if quote else {}, "symbol_subscription_succeeded"),
