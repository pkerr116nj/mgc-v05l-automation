...
def _coerce_open_order_record(payload: dict[str, Any]) -> IbkrOpenOrderRecord:
    return IbkrOpenOrderRecord(
        ...
        quantity=str(payload.get("quantity") or "").strip(),
        action=_coerce_optional_text(payload.get("action") or payload.get("order_action") or payload.get("orderAction")),
        order_type=_coerce_optional_text(payload.get("order_type") or payload.get("orderType")),
        tif=_coerce_optional_text(payload.get("tif") or payload.get("time_in_force") or payload.get("timeInForce")),
        filled_quantity=_coerce_optional_text(payload.get("filled_quantity") or payload.get("filledQuantity")),
        remaining_quantity=_coerce_optional_text(payload.get("remaining_quantity") or payload.get("remainingQuantity")),
