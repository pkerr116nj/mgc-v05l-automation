...
DEFAULT_DATASET_CONTRACTS: tuple[DatasetContract, ...] = (
    ...
    DatasetContract(
        ...
        truth_class="derived_from_canonical_1m",
        partitioning=("symbol", "year", "shard_id"),
        description="Deterministic 15m bars derived from canonical 1m.",
        columns=DERIVED_BAR_COLUMNS,
        metadata={"timeframe": "15m", "source_data_source": "historical_1m_canonical"},
    ),
    DatasetContract(
        dataset_name="derived_bars_60m",
        truth_class="derived_from_canonical_1m",
        partitioning=("symbol", "year", "shard_id"),
        description="Deterministic 60m bars derived from canonical 1m.",
        columns=DERIVED_BAR_COLUMNS,
        metadata={"timeframe": "60m", "source_data_source": "historical_1m_canonical"},
    ),
    DatasetContract(
        dataset_name="derived_bars_240m",
        truth_class="derived_from_canonical_1m",
        partitioning=("symbol", "year", "shard_id"),
        description="Deterministic 240m bars derived from canonical 1m.",
        columns=DERIVED_BAR_COLUMNS,
        metadata={"timeframe": "240m", "source_data_source": "historical_1m_canonical"},
    ),
    DatasetContract(
