...
bash scripts/enable_active_trend_participation_canary.sh >/dev/null
...
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=src .venv/bin/python -m mgc_v05l.app.main \
  ...
  --instruments MES MNQ \
  --phase5-review-json outputs/reports/trend_participation_engine_phase5_review/phase5_review.json
