...
status["track_b_control_plane"] = {
    ...
    "continuation_aware_exit_history_classification": control_plane_snapshot.get("continuation_aware_exit_history_classification") or "CONTINUATION_EXIT_HISTORY_EMPTY",
    "continuation_aware_exit_history_total_events": control_plane_snapshot.get("continuation_aware_exit_history_total_events") or 0,
    "continuation_aware_exit_history_strategy_count": control_plane_snapshot.get("continuation_aware_exit_history_strategy_count") or 0,
    "continuation_aware_exit_history_latest_strategy_id": control_plane_snapshot.get("continuation_aware_exit_history_latest_strategy_id") or "",
    "continuation_aware_exit_history_latest_exit_profile_id": control_plane_snapshot.get("continuation_aware_exit_history_latest_exit_profile_id") or "",
    "continuation_aware_exit_history_latest_exit_state": control_plane_snapshot.get("continuation_aware_exit_history_latest_exit_state") or "",
    "continuation_aware_exit_history_top_strategies": (control_plane_snapshot.get("continuation_aware_exit_history_top_strategies") or [])[:3],
    ...
    "safe_state_submit_allowed": control_plane_snapshot.get("safe_state_submit_allowed") is True,
    "safe_state_observe_only": control_plane_snapshot.get("safe_state_observe_only") is True,
    "safe_state_recovery_only": control_plane_snapshot.get("safe_state_recovery_only") is True,
    "safe_state_tripped_limits": (control_plane_snapshot.get("safe_state_tripped_limits") or [])[:5],
    "safe_state_operator_explanation": control_plane_snapshot.get("safe_state_operator_explanation") or "",
    "safe_state_recommended_next_step": control_plane_snapshot.get("safe_state_recommended_next_step") or "",
