...
| `src/mgc_v05l/app/track_b_paper_lifecycle_adoption.py` | broker-backed lifecycle adoption | high-risk mutation/remediation | Next candidate: require shared Position Truth, Managed Position Registry, Runtime Supervisor Authority, and reconciliation evidence before local lifecycle adoption. |
