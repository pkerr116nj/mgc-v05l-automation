...
- valid OTM call-credit spreads above spot and OTM put-credit spreads below spot receive a subtle side-specific tint; ITM calls below spot and ITM puts above spot receive a light ATM-style blue background while the spread straddling spot retains the stronger highlight;
...
- the page scrolls vertically through strikes; call and put fields snap column-by-column in separate horizontal touch panes while the center strike column remains fixed;
