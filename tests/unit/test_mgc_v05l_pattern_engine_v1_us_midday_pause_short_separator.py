...
from mgc_v05l.app.pattern_engine_v1_us_midday_pause_short_separator import (
    _candidate_row,
    _separator_quality,
)


def test_separator_quality_marks_repeatable_candidate_for_short_lane() -> None:
    assert (
        _separator_quality(
            match_count=8,
...
def test_candidate_row_tracks_repeatability_and_score_for_short_lane() -> None:
    baseline = {
    ...
    candidate = _candidate_row(
        ...
        primitive_value="CURVATURE_FLAT",
    )
