...
def test_managed_exit_close_authority_allows_exact_close_when_runtime_identity_unhealthy(
    tmp_path: Path,
) -> None:
    config = base_config(
        tmp_path,
    ...
    seed_strategy_submit_authority(
        ...
        snapshot_overrides={
            ...
            "safe_to_start_runtime": False,
            "safe_to_leave_runtime_running": False,
            "runtime_resume_action_policy": "RUNTIME_IDENTITY_UNHEALTHY",
            "shared_truth_coherence_status": "STALE_OR_MIXED",
            "position_truth_classification": "OPEN_MANAGED_MATCHED",
            "managed_position_registry_classification": "OPEN_MANAGED_EXIT_DUE",
            "managed_order_registry_classification": "POSITION_WITHOUT_CLOSE_ORDER",
...
def test_managed_exit_close_authority_demotes_stale_safe_state_duplicate_intent_for_exact_v11_close(
    tmp_path: Path,
) -> None:
    config = base_config(
        tmp_path,
        ...
        con_id=812345678,
        side="LONG",
        close_limit_price="3361.2",
        managed_exit_policy_id=TrackBManagedExitPolicy.US_ACTIVE_EVIDENCE_TIMEBOX_60M_EXIT_V1.value,
        managed_exit_v1_1_authorized=True,
    )
    close_intent = {
        "lifecycle_id": "bridge_fill_MGC|1m|2026-06-26T19:00:00Z|BUY_TO_OPEN",
        "trade_id": "trade-mgc-weekend-cleanup",
        "order_action": "SELL",
        "quantity": 1,
        "close_limit_price": "3361.2",
    }
    seed_strategy_submit_authority(
        ...
        limit_price="3361.2",
        safe_state_overrides={
            "safe_state_classification": "SAFE_STATE_DUPLICATE_INTENT_RISK",
            "submit_allowed": False,
            "broker_mutation_allowed": False,
        ...
        snapshot_overrides={
            "open_order_truth_classification": OPEN_CLOSE_ORDER_WORKING,
            "managed_order_registry_classification": "POSITION_WITHOUT_CLOSE_ORDER",
            "position_truth_classification": "OPEN_MANAGED_MATCHED",
            "managed_position_registry_classification": "OPEN_MANAGED_EXIT_DUE",
        },
...
def test_managed_exit_close_authority_keeps_real_duplicate_order_truth_hard_blocker(
    ...
    assert close_authority["allowed"] is False
    assert any(str(reason).startswith("CONFLICTING_CLOSE_ORDER:") for reason in close_authority["block_reasons"])


def test_managed_exit_close_authority_keeps_unknown_order_truth_hard_blocker(
    tmp_path: Path,
) -> None:
    config = base_config(
        tmp_path,
    ...
    seed_strategy_submit_authority(
        ...
        snapshot_overrides={
            "open_order_truth_classification": "UNKNOWN_OPEN_ORDERS_PRESENT",
            "managed_order_registry_classification": "UNKNOWN_OPEN_ORDERS_PRESENT",
        },
    )
...
def test_managed_exit_close_authority_keeps_review_required_order_truth_hard_blocker(
    tmp_path: Path,
) -> None:
    config = base_config(
        tmp_path,
    ...
    seed_strategy_submit_authority(
        ...
        snapshot_overrides={
            "open_order_truth_classification": "NO_OPEN_ORDERS",
            "managed_order_registry_classification": "REVIEW_REQUIRED",
        },
    )
...
def test_managed_exit_close_authority_normalizes_review_required_registry_identity(
    ...
    assert authorization["classification"] == lifecycle_module.STRATEGY_SUBMIT_AUTHORIZED
    assert authorization["registry_identity_normalization"]["classification"] == "REGISTRY_IDENTITY_NORMALIZATION_CURRENT_SCOPE_SUPERSEDED"
