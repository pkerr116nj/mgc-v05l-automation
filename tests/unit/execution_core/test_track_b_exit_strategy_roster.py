...
from mgc_v05l.execution_core.track_b_exit_strategy_roster import (
    ...
    ETH_DIAGNOSTIC_TIMEBOX_3X5M_V1,
    ...
    MET_DIAGNOSTIC_TIMEBOX_3X5M_V1,
    ...
    MSL_DIAGNOSTIC_TIMEBOX_3X5M_V1,
    ...
    SOL_DIAGNOSTIC_TIMEBOX_3X5M_V1,
...
def test_validated_futures_diagnostic_timebox_profiles_resolve_by_policy_and_instrument() -> None:
    for symbol, profile_id, tick_size in (
        ...
        ("ETH", ETH_DIAGNOSTIC_TIMEBOX_3X5M_V1, "0.5"),
        ("MET", MET_DIAGNOSTIC_TIMEBOX_3X5M_V1, "0.5"),
        ("SOL", SOL_DIAGNOSTIC_TIMEBOX_3X5M_V1, "0.05"),
        ("MSL", MSL_DIAGNOSTIC_TIMEBOX_3X5M_V1, "0.05"),
    ):
        profile = resolve_track_b_exit_profile_for_position(
...
def test_batch1_active_evidence_profiles_cover_validated_symbols() -> None:
    for symbol, us_profile_id, globex_profile_id, tick_size in (
        ...
        ("ETH", ETH_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1, ETH_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1, "0.5"),
        ("MET", MET_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1, MET_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1, "0.5"),
        ("SOL", SOL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1, SOL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1, "0.05"),
        ("MSL", MSL_US_ACTIVE_EVIDENCE_TIMEBOX_60M_V1, MSL_GLOBEX_ACTIVE_EVIDENCE_TIMEBOX_15M_V1, "0.05"),
    ):
