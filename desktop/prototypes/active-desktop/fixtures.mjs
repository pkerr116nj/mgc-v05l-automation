...
export const venues = Object.freeze([
  { id: "nyse", city: "New York", label: "NYSE", region: "North America", x: 27.2, y: 39.4, labelDx: 1.5, labelDy: -2.2 },
  { id: "nasdaq", city: "New York", label: "Nasdaq", region: "North America", x: 28.2, y: 40.4, labelDx: 1.6, labelDy: 0.8 },
  { id: "cboe", city: "New York", label: "Cboe", region: "North America", x: 29.2, y: 41.4, labelDx: 1.6, labelDy: 3.5 },
  { id: "cme", city: "Chicago", label: "CME", region: "North America", x: 22.6, y: 39.8, labelDx: -7.2, labelDy: -1.6 },
  { id: "cfe", city: "Chicago", label: "CFE", region: "North America", x: 21.8, y: 42.2, labelDx: -6.5, labelDy: 1.7 },
  { id: "tsx", city: "Toronto", label: "TSX", region: "North America", x: 25.1, y: 35.8, labelDx: -6.3, labelDy: -2.3 },
  { id: "mx", city: "Montreal", label: "MX", region: "North America", x: 29.1, y: 35.4, labelDx: 1.4, labelDy: -1.7 },
  { id: "bmv", city: "Mexico City", label: "BMV", region: "North America", x: 19.3, y: 52.8, labelDx: -7.8, labelDy: 1.1 },
  { id: "b3", city: "Sao Paulo", label: "B3", region: "South America", x: 36.2, y: 73.8, labelDx: 1.6, labelDy: 0.8 },
  { id: "lse", city: "London", label: "LSE / ICE", region: "Europe", x: 48.5, y: 36.1, labelDx: -7.1, labelDy: -2.0 },
  { id: "eurex", city: "Frankfurt", label: "Deutsche Borse / Eurex", region: "Europe", x: 52.1, y: 38.8, labelDx: 1.5, labelDy: -1.2 },
  { id: "paris", city: "Paris", label: "Euronext Paris", region: "Europe", x: 50.3, y: 42.0, labelDx: -5.7, labelDy: 3.5 },
  { id: "amsterdam", city: "Amsterdam", label: "Euronext Amsterdam", region: "Europe", x: 51.0, y: 36.3, labelDx: 1.3, labelDy: -4.0 },
  { id: "six", city: "Zurich", label: "SIX", region: "Europe", x: 53.1, y: 42.5, labelDx: 1.5, labelDy: 3.0 },
  { id: "jpx", city: "Tokyo", label: "JPX / TSE", region: "Asia-Pacific", x: 85.4, y: 45.4, labelDx: 1.5, labelDy: -2.0 },
  { id: "osaka", city: "Osaka", label: "Osaka", region: "Asia-Pacific", x: 83.6, y: 48.8, labelDx: 1.3, labelDy: 2.8 },
  { id: "hkex", city: "Hong Kong", label: "HKEX", region: "Asia-Pacific", x: 75.6, y: 55.9, labelDx: 1.6, labelDy: 2.4 },
  { id: "sgx", city: "Singapore", label: "SGX", region: "Asia-Pacific", x: 73.5, y: 66.3, labelDx: 1.5, labelDy: 2.5 },
  { id: "krx", city: "Seoul", label: "KRX", region: "Asia-Pacific", x: 80.8, y: 45.3, labelDx: -5.4, labelDy: -2.5 },
  { id: "twse", city: "Taipei", label: "TWSE", region: "Asia-Pacific", x: 78.6, y: 52.7, labelDx: 1.3, labelDy: -1.4 },
  { id: "sse", city: "Shanghai", label: "Shanghai", region: "Asia-Pacific", x: 76.9, y: 49.9, labelDx: -8.4, labelDy: -1.8 },
  { id: "szse", city: "Shenzhen", label: "Shenzhen", region: "Asia-Pacific", x: 76.1, y: 54.8, labelDx: -8.0, labelDy: 2.5 },
  { id: "nse", city: "Mumbai", label: "NSE / BSE", region: "Asia-Pacific", x: 64.5, y: 59.2, labelDx: -7.3, labelDy: 1.5 },
  { id: "asx", city: "Sydney", label: "ASX", region: "Asia-Pacific", x: 85.3, y: 80.0, labelDx: -5.6, labelDy: 1.0 },
  { id: "nzx", city: "Auckland", label: "NZX", region: "Asia-Pacific", x: 93.0, y: 83.5, labelDx: -8.0, labelDy: 0.9 },
]);
