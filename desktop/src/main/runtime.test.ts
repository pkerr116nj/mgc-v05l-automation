...
function makeDesktopState(overrides: Partial<DesktopState> = {}): DesktopState {
  return {
    ...
    notifications: {
      policyPath: "/tmp/track_b_operator_notification_policy.json",
      eventLogPath: "/tmp/track_b_operator_notifications.jsonl",
      latestStatePath: "/tmp/track_b_operator_notifications_latest.json",
      policy: {
        enabled: true,
        enabled_event_types: {},
